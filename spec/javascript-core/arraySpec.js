...
describe("Arrays", function () {
    ...
    describe("EXAMPLES", function () {
        ...
        it("remove an item using splice", function () {

            var thingsToBuy = ['bread', 'milk', 'ham', 'cheese', 'coffee', 'biscuits', 'eggs'];
            // i don't like coffee - lets remove it from the array
            thingsToBuy.splice(4, 1);
            expect(thingsToBuy).toEqual(['bread', 'milk', 'ham', 'cheese', 'biscuits', 'eggs']);
